...
import __future__
"""
Lambda's can't use environments so we hard-code things or we put them in an s3 bucket and load it from there
which requires another configuration in here for the bucket etc etc etc. Hard coding it is.
