...
docker tag -f $CYBERGREEN_AWS_CONTAINER_IMAGE:latest $CYBERGREEN_CONTAINER_REPO/$CYBERGREEN_AWS_CONTAINER_IMAGE:latest
docker push $CYBERGREEN_CONTAINER_REPO/$CYBERGREEN_AWS_CONTAINER_IMAGE:latest
